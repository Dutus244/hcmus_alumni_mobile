...
Widget myProfileAddEducation(BuildContext context) {
  return Column(
      ...
      children: [
        Expanded(
          ...
          children: [
            buildTextFieldSchoolName(context, translate('school_name'), '', '', (value) {
              context.read<MyProfileAddEducationBloc>().add(SchoolNameEvent(value));
            }),
            buildTextFieldDegree(context, translate('degree_name'), '', '', (value) {
...
Widget buildTextFieldSchoolName(BuildContext context, String hintText,
...
Widget buildTextFieldDegree(BuildContext context, String hintText,
    String textType, String iconName, void Function(String value)? func) {
  TextEditingController _controller = TextEditingController(
...
Widget buttonAdd(BuildContext context) {
  String compayName = BlocProvider.of<MyProfileAddEducationBloc>(context).state.schoolName;
  return GestureDetector(
    onTap: () {
      if (compayName != "") {
