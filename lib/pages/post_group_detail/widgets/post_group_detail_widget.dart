...
import '../post_group_detail_controller.dart';
...
Widget listComment(BuildContext context, ScrollController _scrollController,
    String id) {
  String content =
      BlocProvider.of<PostGroupDetailBloc>(context).state.content;
  Comment? comment =
      BlocProvider.of<PostGroupDetailBloc>(context).state.children;
  Post? posts = BlocProvider.of<PostGroupDetailBloc>(context).state.post;
    ...
    children: [
      Expanded(
        child: ListView.builder(
          ...
          itemCount: BlocProvider.of<PostGroupDetailBloc>(context)
              .state
              .comments
              .length +
              1,
          itemBuilder: (BuildContext context, int index) {
            switch (BlocProvider.of<PostGroupDetailBloc>(context)
                .state
                .statusComment) {
              case Status.loading:
                return Column(
      ...
      if (Global.storageService.permissionCounselCommentCreate())
        navigation(context, content, comment, id, (value) {
          context.read<PostGroupDetailBloc>().add(ContentEvent(value));
        })
    ],
  );
}
...
Widget navigation(BuildContext context, String content, Comment? comment,
  ...
  return Container(
    child: Column(
      children: [
        if (BlocProvider.of<PostGroupDetailBloc>(context).state.reply ==
            0)
          Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        context
                            .read<PostGroupDetailBloc>()
                            .add(ContentEvent(''));
                        // context.read<PostGroupDetailBloc>().add(
                      ...
                      onTap: () {
                        if (content != "") {
                          PostGroupDetailController(context: context)
                              ...
                              id,
                              BlocProvider.of<PostGroupDetailBloc>(
                                  context)
                                  .state
                                  .children!
                                  .id);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: BlocProvider.of<PostGroupDetailBloc>(context)
                          .state
                          .reply ==
                          1
                          ? () {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  PostGroupDetailController(context: context).handleLoadPostData(post.id);
                },
                child: Container(
